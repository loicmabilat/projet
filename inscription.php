                ...
                if(is_numeric($tel))
                {
                        ...
                        {$requetemail = $bdd -> prepare("SELECT * FROM users WHERE email = ?");
                                ...
                                if($emailexist == 0 )
                                {
                                        ...
                                        {
                                        $insertmbr = $bdd->prepare("INSERT INTO users(nom, prenom, email, telephone, mdp) VALUES(?, ?, ?, ?, ?)");
                                        $insertmbr->execute(array($nom, $prenom, $email, $tel, $mdp));
...
<div class="accueil">
        ...
        <form method="post" action="">
                        ...
                        <input type="text" name="mdp" class="motdepasse"  size="40" maxlength="30" />
                        </p>
                
                        <p>
                        <label for="confirmdp">confirmer votre mot de passe</label></br>
                        <input type="text" name="confirmdp" class="confirmdp"  size="40" maxlength="30" />
                        </p>
                        <div class="soumettre">
        ...
        <form method="post" action="" >
                ...
                mon courriel email, nom et mot de passe sur ce site, 
        et je suis majeur.<input type="checkbox" name="accord" class="checkbox" />
                </div></br>
        </form>
        </div>
